                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                          ...
                          disabled={actionInProgress === page.page_id || pageToDelete?.id === page.id || syncing}
                          className={`p-2 text-gray-600 hover:text-blue-600 rounded transition-colors ${
                              (actionInProgress === page.page_id || pageToDelete?.id === page.id || syncing) ? 'opacity-50 cursor-not-allowed' : ''
                          }`}
