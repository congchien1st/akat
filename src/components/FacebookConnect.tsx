...
import { initFacebookSDK, loginWithFacebook, getFacebookPages, connectFacebookPage } from '../lib/facebook';
...
function FacebookConnect({ onConnect }: FacebookConnectProps) {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      // Connect all pages
      await Promise.all(pages.map(page => connectFacebookPage(page)));
