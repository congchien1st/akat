/*
  # Add moderation type to auto engines

  1. Changes
    - Create auto_engines table with all required columns
    - Add moderation type to type check constraint
    - Add default moderation config function
    - Add proper RLS policies
  
  2. Security
    - Enable RLS on auto_engines table
